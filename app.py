...
# Link da sua planilha (Planilha B - Controle)
...
if senha_acesso:
    ...
    if autorizado:
        ...
        if "API_KEY" in st.secrets:
            ...
            # MODELO ATUALIZADO CONFORME DIAGNÓSTICO DE 2026
            ...
            with col4:
                plataforma = st.selectbox(t["plat"], t["redes"])
